                  ...
                  <Link href={`/handles/${user.username}`}>
                    <a>
                      <button
                        className={
                          user.rank < 4
                            ? "bg-transparent hover:bg-trust-yellow hover:border-trust-blue font-semibold hover:text-trust-blue py-2 px-8 border hover:border-transparent rounded mt-2 mr-4 lg:mr-8 items-center mx-auto text-white border-white"
                            : "bg-transparent hover:bg-trust-yellow hover:border-trust-blue font-semibold hover:text-trust-blue py-2 px-8 border hover:border-transparent rounded mt-2 mr-4 lg:mr-8 items-center mx-auto text-trust-blue border-trust-blue"
                        }
                      >
                        VOTE
                      </button>
