    ...
    <div className="max-w-6xl mx-auto sm:px-2 md:px-2 mt-4">
      <div key={user.username}>
        <div className="mb-2 hidden md:px-1 lg:px-4 sm:block">
          <div className="rounded-lg xl:max-w-screen-xl bg-white border-2 border-trust-blue">
            <div className="h-20 md:h-24 flex flex-row items-center">
              <div className="-mt-2 md:-mt-3 mr-1.5 -ml-1 text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-24 w-12 md:h-28 md:w-16 lg:h-28 lg:w-16 fill-current text-trust-blue"
                  viewBox="0 0 24 24"
              ...
              <div className="flex-none ml-2 mr-4 inline-block p-0.5 rounded-full bg-trust-blue">
                <img
              ...
              <div className="flex flex-col w-60 md:w-64 lg:w-96 text-trust-blue">
              ...
              <div className="ml-2 md:ml-8 lg:ml-36 flex flex-col w-32 items-end text-trust-blue">
              ...
              <div className="px-2 md:px-4 lg:px-6 text-trust-blue">
                <div>
                  <BlueLine />
                </div>
              </div>
              ...
              <Link href={`/handles/${user.username}`}>
                <a className="flex ml-4 md:ml-20 lg:ml-16 mr-2">
                  <button className="bg-transparent hover:bg-trust-yellow font-semibold hover:text-trust-blue py-1 px-2 md:py-2 md:px-4 border hover:border-trust-blue rounded mr-4 items-end text-trust-blue border-trust-blue">
                    VOTE
                  </button>
                </a>
              </Link>
        ...
        <div className="mb-1 block sm:hidden px-4 py-2">
          <div className="rounded-lg max-w-full bg-white border-2 border-trust-blue">
            <div className="h-20 md:h-24 flex flex-row items-center">
              <div className="flex mt-1 mr-1.5 -ml-1 text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-28 w-16 fill-current text-trust-blue"
                  viewBox="0 0 24 24"
                  preserveAspectRatio="none"
                >
                  <path d="M0 0h24v24H0z" fill="none" />
              ...
              <div className="ml-1 mr-8 inline-block p-0.5 mt-2 rounded-full bg-trust-blue">
                <img
              ...
              <div className="flex flex-grow justify-end">
                <Link href={`/handles/${user.username}`}>
                  <a>
                    <button className="bg-transparent hover:bg-trust-yellow font-semibold hover:text-trust-blue py-2 px-8 border hover:border-transparent rounded mt-2 mr-4 lg:mr-8 items-center mx-auto text-trust-blue border-trust-blue">
                      VOTE
                    </button>
                  </a>
                </Link>
            ...
            <div className="flex flex-row font-karla text-lg justify-center text-trust-blue">
              {user.name}
            </div>
            <div className="flex flex-row font-karla text-base justify-center text-trust-blue">
              @{user.username}
            </div>
